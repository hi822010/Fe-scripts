...
-- Criação da Death Part
local deathPart = Instance.new("Part")
deathPart.Name = "DeathPart"
deathPart.Size = Vector3.new(6, 1, 6)
deathPart.Anchored = true
deathPart.CanCollide = true
deathPart.BrickColor = BrickColor.new("Really red")
deathPart.Material = Enum.Material.Neon
deathPart.Transparency = 0.2
deathPart.Position = workspace.CurrentCamera.CFrame.Position + Vector3.new(0, 5, 0)
deathPart.Parent = workspace

-- Conexão do evento Touched
deathPart.Touched:Connect(death)
